...
class LIF:
    def __init__(self, dt=0.01, tau_m=20, V_rest=-65.0, R=10.0, I_back=0.3, V_reset=-65.0, V_th=-50.0, V_ref=3):
        '''
        param dt: 刻み幅 [ms]
...
class SNN:
    def __init__(self, n_exc, n_inh, dt=0.01, device='cuda'):
        ...
        self.E_stdp = Guetig_STDP(A_plus=0.02, A_minus=0.03, tau_plus=2.0, tau_minus=15.0, device=self.device)
        self.I_stdp = Guetig_STDP(A_plus=0.03, A_minus=0.01, tau_plus=20.0, tau_minus=10.0, device=self.device)
